...
import rospy
import actionlib
from mavros_msgs.srv import CommandBool, SetMode , CommandBoolRequest,SetModeRequest,CommandHome
...
# SEE Why this was not workingggggggggggg
    ...
    def dist_from_closest_lndng_stn(self):
        ...
        lndng_stn1.pose.position.x=
        lndng_stn1.pose.position.y=
        lndng_stn1.pose.position.z=
        lndng_stn2=PoseStamped()
        lndng_stn2.pose.position.x=
        lndng_stn2.pose.position.y=
        lndng_stn2.pose.position.x=
